package com.example.rutescompartidesapp.view.route_detail.edit_route
...
fun EditRouteScreen(routeID: Int, navHost: NavHostController ){
    ...
    Scaffold( modifier = Modifier
        ...
        topBar = {
            TopAppBar(
                title = { Text(text = "Editar Ruta $routeID# $currentStep/3") },
                navigationIcon = {
                    IconButton(onClick = {
...
private fun PublishRouteContent3(
    ...
    Row(
        ...
        PublishButton( onClick = {manageRouteViewModel.updateRoute()}, text = "Editar ruta")
    }
}
